...
class ClusterCommandsTestCase(unittest.TestCase):
    ...
    def test_append(self):
        ...
        self.assertRaises(
            rediscluster.ResponseError, self.client.append, 'a', 'a1')
        del self.client['a']
        # real logic
    ...
    def test_substr(self):
        ...
        self.client.rpush('a', 'a1')
        self.assertRaises(
            rediscluster.ResponseError, self.client.substr, 'a', 0)
        del self.client['a']
        # real logic
    ...
    def test_lindex(self):
        ...
        self.client['a'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.lindex, 'a', '0')
        del self.client['a']
        # real logic
    ...
    def test_lpush(self):
        ...
        self.client['a'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.lpush, 'a', 'a')
        del self.client['a']
        # real logic
    ...
    def test_lpushx(self):
        ...
        self.client['a'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.lpushx, 'a', 'a')
        del self.client['a']
        # real logic
    ...
    def test_lrange(self):
        ...
        self.client['a'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.lrange, 'a', 0, 1)
        del self.client['a']
        # real logic
    ...
    def test_lrem(self):
        ...
        self.client['a'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.lrem, 'a', 0, 'b')
        del self.client['a']
        # real logic
    ...
    def test_lset(self):
        # no key
        self.assertRaises(
            rediscluster.ResponseError, self.client.lset, 'a', 1, 'b')
        # key is not a list
        self.client['a'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.lset, 'a', 1, 'b')
    ...
    def test_ltrim(self):
        ...
        self.client['a'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.ltrim, 'a', 0, 2)
        del self.client['a']
        # real logic
        self.make_list('a', 'abc')
    ...
    def test_rpoplpush(self):
        ...
        self.client['a'] = 'a1'
        self.assertRaises(
            rediscluster.ResponseError, self.client.rpoplpush, 'a', 'b')
        del self.client['a']
    ...
    def test_rpush(self):
        ...
        self.client['a'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.rpush, 'a', 'a')
        del self.client['a']
        # real logic
    ...
    def test_rpushx(self):
        ...
        self.client['a'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.rpushx, 'a', 'a')
        del self.client['a']
        # real logic
    ...
    def test_sadd(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.sadd, 'a', 'a1')
        del self.client['a']
        # real logic
    ...
    def test_sdiff(self):
        ...
        self.client['b'] = 'b'
        self.assertRaises(
            rediscluster.ResponseError, self.client.sdiff, ['a', 'b'])
        del self.client['b']
        # real logic
    ...
    def test_sismember(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.sismember, 'a', 'a')
        del self.client['a']
        # real logic
        self.make_set('a', 'abc')
    ...
    def test_smembers(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.smembers, 'a')
        del self.client['a']
        # set doesn't exist
    ...
    def test_srandmember(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.srandmember, 'a')
        del self.client['a']
        # real logic
        self.make_set('a', 'abc')
    ...
    def test_srem(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.srem, 'a', 'a')
        del self.client['a']
        # real logic
        self.make_set('a', 'abc')
    ...
    def test_zcount(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.zcount, 'a', 0, 0)
        del self.client['a']
        # real logic
        self.make_zset('a', {'a1': 1, 'a2': 2, 'a3': 3})
    ...
    def test_zincrby(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.zincrby, 'a', 'a1')
        del self.client['a']
        # real logic
        self.make_zset('a', {'a1': 1, 'a2': 2, 'a3': 3})
    ...
    def test_zrank(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.zrank, 'a', 'a4')
        del self.client['a']
        # real logic
        self.make_zset('a', {'a1': 1, 'a2': 2, 'a3': 3, 'a4': 4, 'a5': 5})
    ...
    def test_zrem(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.zrem, 'a', 'a1')
        del self.client['a']
        # real logic
        self.make_zset('a', {'a1': 1, 'a2': 2, 'a3': 3})
    ...
    def test_zrevrank(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.zrevrank, 'a', 'a4')
        del self.client['a']
        # real logic
    ...
    def test_zscore(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.zscore, 'a', 'a1')
        del self.client['a']
        # real logic
    ...
    def test_hget_and_hset(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.hget, 'a', 'a1')
        del self.client['a']
        # no key
    ...
    def test_hmget_no_keys(self):
        self.assertRaises(
            rediscluster.ResponseError, self.client.hmget, 'foo', [])

    def test_hdel(self):
        # key is not a hash
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.hdel, 'a', 'a1')
        del self.client['a']
        # no key
    ...
    def test_hexists(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.hexists, 'a', 'a1')
        del self.client['a']
        # no key
    ...
    def test_hincrby(self):
        ...
        self.client['a'] = 'a'
        self.assertRaises(
            rediscluster.ResponseError, self.client.hincrby, 'a', 'a1')
        del self.client['a']
